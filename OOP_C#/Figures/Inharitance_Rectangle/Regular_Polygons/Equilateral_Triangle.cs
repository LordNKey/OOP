...
{
    internal class Equilateral_Triangle : Circle
    {
        public Equilateral_Triangle(Color fill_color_, Color border_color_, PointF top_corner_point, PointF lower_corner_point) :
